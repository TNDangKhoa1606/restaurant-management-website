        ...
        <footer className="bg-bg-dark-1 text-text-footer">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-center md:justify-start space-x-4">
                                <a href="#" className="text-text-footer hover:text-primary transition-colors"><i className="icon-social-facebook text-xl"></i></a>
                                <a href="#" className="text-text-footer hover:text-primary transition-colors"><i className="icon-social-twitter text-xl"></i></a>
                                <a href="#" className="text-text-footer hover:text-primary transition-colors"><i className="icon-social-instagram text-xl"></i></a>
                            </div>
                        </div>
            ...
            <div className="bg-black py-4">
                <div className="container mx-auto px-4 text-center">
                    <p className="text-sm text-text-muted">© Bản quyền {new Date().getFullYear()} NOODLES Restaurant. Thiết kế bởi <a href="#" className="text-primary hover:underline">Net Solutions</a></p>
                </div>
            </div>
        </footer>
    );
