                            ...
                            <ul className="flex items-center space-x-8 text-base pt-4 font-medium">
                                ...
                                <li>
                                    <select
                                        ...
                                        className="currency-select bg-transparent border border-primary text-text-light text-sm px-2 py-1 rounded-full focus:outline-none focus:ring-1 focus:ring-primary"
                                    >
                                ...
                                {user ? (
                                    ...
                                    <li className="relative" ref={loginDropdownRef}>
                                        ...
                                        {isLoginDropdownOpen && (
                                            <div className="absolute top-full right-0 mt-2 w-48 bg-bg-dark-1 border border-gray-700 rounded-lg shadow-xl py-2 z-50">
                                                <Link
                                                    to="/login"
                                                    className="block px-4 py-2 text-text-light hover:bg-primary hover:text-white transition-colors"
            ...
            <div id="mobile-menu" className={`fixed top-0 right-0 h-full w-64 bg-bg-dark-1 shadow-lg transform ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out lg:hidden`}>
                <div className="p-5">
                    ...
                    <ul className="flex flex-col space-y-4 mt-10 text-center">
                        ...
                        {!user && (
                            <>
                                <li><Link to="/login" className={navLinkClasses} onClick={() => setMobileMenuOpen(false)}>Đăng nhập (Khách)</Link></li>
                                <li><Link to="/internal/login" className={navLinkClasses} onClick={() => setMobileMenuOpen(false)}>Đăng nhập (Nhân viên)</Link></li>
                            </>
                        )}
                        <li className="pt-4">
